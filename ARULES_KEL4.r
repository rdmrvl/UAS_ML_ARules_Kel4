...
### IMPORT DATA ###
data <- read.csv("transaksi_gabungan.csv", sep = ";")   # ganti sama direktori file yang sesuai
...
data$ITEM <- gsub("KASA STERIL|BEDAK BAYI|PLESTER|ANTISEPTIK|HAND SANITIZER|HAND SANITIZER|MINYAK TELON|BEDAK TABUR|ROKOK|TOLAK ANGIN|OBAT SAKIT KEPALA|OBAT PUSING", "OBAT-OBATAN", data$ITEM)
...
data$ITEM <- gsub("SUNLIGHT|MAMA LEMON|PEMBERSIH PIRING|ALAT MASAK (PANCI, SPATULA, SENDOK)|SPONGE|SPONS CUCI PIRING SCOTCH-BRITE|SPON|PENCUCI PIRING|SIKAT BOTOL", "PEMBERSIH ALAT MAKAN", data$ITEM)
...
data$ITEM <- gsub("SENDAL|KAOS KAKI|SEPATU|SWALLOW SJD|CELANA|BAJU|GANTUNGAN BAJU|SPREI|CELANA PENDEK|SOFTLENS|CAIRAN SOFTLENS|CELANA|KALUNG|LENSA KONTAK|KACAMATA|WIG|BAJU|MASKER", "PAKAIAN", data$ITEM)
...
data$ITEM <- gsub("BIHUN|SO'UN|SPAGETI|SPAGHETTI|SAMYANG|MI INSTAN|BIHUN JAGUNG|SARIMI|PASTA SPAGHETTI|SPAGHETI|MIEGHETTI|POP MIE|LEMONILO|INDOMIE|POPMIE|MIE GELAS|PASTA BAYI|BEST WOK MIE|MIE BURUNG DARA|MIE SAMYANG|MIE SEDAAP GORENG|RAMEN|MIE JUMBO|MIE WADAH BASO (2)|MIE WADAH KR(2)|MIE GORENG|MIE INSTAN", "MIE", data$ITEM)
...
data$ITEM <- gsub("RICOLA|MANISAN|YUPI|MANISAN (YUPI)|YUPI LITTLE STARS|KOPIKO|KOPIKO CANDY|ALPHELIEBE|CHUPA CHUPS|MENTOS|ALPHALIBE|MENTOS MINT|MENTOS CANDY|PERMEN|BLASTER|PERMEN KARET", "PERMEN", data$ITEM)
data$ITEM <- gsub("GLICO POCKY|POCKY|CHOCOLATOS|CHOCO PIE|BENG BENG SHARE IT|TOBLERONE|SILVER QUEEN|KIT KAT|COKI-COKI|BENGBENG|SILVERQUEEN|CADBURY|DELFI CHICCHOC|BETTER|DELFI TAKE IT|CHIC CHOC|SNICKERS|CHACHA|KITKAT|KINDERJOY|CADBURY DAIRY MILK|DARK CHOCOLATTE|COKELAT|COKLAT DAN SUSU|COKLAT DAN MINUMAN DINGIN|COKLAT CADBURY|CERES|MESES|COKLAT", "COKLAT", data$ITEM)
data$ITEM <- gsub("MAICIH|HATARI|FF COCONUT TPK|RISOL MAYO|MAXI CORN,FUZO|TWISTKO|MAKANAN RINGAN|J&J PIATTOS|OISHI PILLOWS|QTELA|SINDE|JETZ|PRINGLES ORIGINAL|CITATO|JAPOTA|MAITOS|CHITATO|LAYS|PRINGLES|MIN-BEE|CHEETOS|SPONGE|DORITOS|MAMASUKA RUMPUT LAUT|KUSUKA KEJU BAKAR|GORENGAN|MARSHMALLOW|KUACI|KUACI REBO|KUACI FUZO|HAPPY TOS|KERIPIK PISANG|STIK KEJU|KERIPIK|KRIPIK|POTABEE|CHIKI|CHIKI(2)|OISHI POPPY|HELLO PANDA|BERNARD EASY BITE|MONDE|WAFLE|WAFER|POPCORN|TARO|NYAM-NYAM|TARO BALL|BRONDONG JAGUNG|ASTOR|SNACK|FISH SNACK WRAP|SNACK SAPI|SNACK BALADO 140|SNACK BAYI|SNACK BROWNIES|KUE|KUE OREO|KUE COKLAT", "SNACK", data$ITEM)
